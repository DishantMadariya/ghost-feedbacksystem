...
const Sidebar = ({ open, setOpen, admin, onLogout }) => {
  ...
  const filteredNavigation = navigation.filter(item => 
    admin.permissions[item.permission]
  );
             ...
             <div className="flex-1 flex flex-col pt-5 pb-4">
               <div className="flex items-center flex-shrink-0 px-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h1 className="text-lg font-bold text-ghost-900">Ghost Feedback</h1>
               ...
               <nav className="mt-8 px-2 space-y-1">
                {filteredNavigation.map((item) => {
                  ...
                  return (
                       ...
                       key={item.name}
                       to={item.href}
                       end={item.href === '/admin' || item.href === '/admin/suggestions'}
                       className={({ isActive }) => {
            ...
            <div className="flex-shrink-0 flex border-t border-ghost-200 p-4">
              <div className="flex items-center w-full">
                ...
                <div className="ml-3 flex-1">
                  <p className="text-sm font-medium text-ghost-900">{admin.fullName}</p>
